// ==========================================================
// ARCHIVO: src/env.ts
// Validador de Variables de Entorno para Next.js / Supabase
// ==========================================================

import { z } from 'zod';

const envSchema = z.object({
  // Servidor (Solo accesibles en Server Components / Server Actions / API Routes)
  SUPABASE_SERVICE_ROLE_KEY: z.string().optional(),
  DATABASE_URL: z.string().optional(),
  GEMINI_API_KEY: z.string().optional(),

  // Cliente (Expuestas al navegador con NEXT_PUBLIC_)
