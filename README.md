...
├── src/
│   ├── app/                # Rutas y layouts principales (Next.js App Router)
│   ├── components/         # Componentes modulares (Header, Navbar, Hero, etc.)
│   ├── context/            # Manejo de estado global (Multi-idioma)
│   └── data/               # Base de datos local de plataformas y enlaces de afiliados
├── package.json
└── tailwind.config.js